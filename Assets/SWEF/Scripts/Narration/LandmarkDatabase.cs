    ...
    public class LandmarkDatabase : ScriptableObject
    {
        ...
        private void PopulateBuiltInData()
        {
            landmarks.AddRange(new[]
            {
                ...
                Make("lm_mount_fuji",     "Mount Fuji",         35.3606, 138.7274, 3776f,LandmarkCategory.Natural,      "Japan",   "Fujinomiya","Shizuoka",        0,   "",                  true,  5000f, NarrationTriggerType.FlyOver,   NarrationPriority.Normal,  "landmark_natural",    new[]{"japan","volcano","mountain","iconic"}),
                ...
                Make("lm_victoria_falls", "Victoria Falls",     -17.9243,  25.8572, 850f,LandmarkCategory.Natural,      "Zimbabwe","Livingstone","Matabeleland",-1000000,"Natural",         true,  3000f, NarrationTriggerType.FlyOver,   NarrationPriority.High,    "landmark_natural",    new[]{"africa","waterfall","zambezi","wonder"}),
                Make("lm_kilimanjaro",    "Mount Kilimanjaro",   -3.0674,  37.3556,5895f,LandmarkCategory.Natural,      "Tanzania","Moshi",   "Kilimanjaro",      0,   "",                  true,  8000f, NarrationTriggerType.FlyOver,   NarrationPriority.Normal,  "landmark_natural",    new[]{"africa","mountain","volcano","highest"}),
                ...
                Make("lm_amazon_river",   "Amazon River Source",-15.5047, -70.0684,4800f,LandmarkCategory.Natural,      "Peru",    "Puno",    "Puno",             0,   "",                  false, 5000f, NarrationTriggerType.FlyOver,   NarrationPriority.Low,     "landmark_natural",    new[]{"amazon","peru","river","source"}),
                Make("lm_iguazu_falls",   "Iguaçu Falls",      -25.6953, -54.4367,  200f,LandmarkCategory.Natural,      "Brazil",  "Foz do Iguaçu","Paraná",       0,  "",                  true,  3000f, NarrationTriggerType.FlyOver,   NarrationPriority.Normal,  "landmark_natural",    new[]{"brazil","argentina","waterfall","falls"}),
                ...
                Make("lm_great_barrier_reef","Great Barrier Reef",-18.2871,147.6992,  0f, LandmarkCategory.Natural,     "Australia","Cairns","Queensland",          0,  "",                  true,  10000f,NarrationTriggerType.FlyOver,   NarrationPriority.Normal,  "landmark_natural",    new[]{"australia","reef","coral","marine"}),
                ...
                Make("lm_aurora_borealis","Aurora viewing site", 69.6796,  18.9570,    0f, LandmarkCategory.Natural,    "Norway",  "Tromsø","Troms",               0,  "",                  false, 20000f,NarrationTriggerType.TimeOfDay, NarrationPriority.Normal,  "landmark_natural",    new[]{"norway","aurora","northern_lights","night"}),
                Make("lm_venice_canals",  "Venice Grand Canal",  45.4408,  12.3155,    0f, LandmarkCategory.Cultural,   "Italy",   "Venice","Veneto",              697, "",                  true,  1500f, NarrationTriggerType.Proximity, NarrationPriority.Normal,  "landmark_cultural",   new[]{"italy","venice","canal","renaissance"}),
                ...
                Make("lm_mount_everest",  "Mount Everest",       27.9881,  86.9250, 8849f,LandmarkCategory.Natural,     "Nepal",   "Solukhumbu","Sagarmatha",       0,  "",                  true,  15000f,NarrationTriggerType.FlyOver,   NarrationPriority.Critical,"landmark_natural",    new[]{"nepal","everest","himalaya","summit"}),
            });
